// LupuS Software Center – i18n (Internationalization)
...
pub fn detect_system_lang() -> String {
    // POSIX precedence: LANGUAGE > LC_ALL > LC_MESSAGES > LANG
    // LANGUAGE can be colon-separated list, e.g. "en_US:en"
    let candidates = [
        std::env::var("LANGUAGE").unwrap_or_default(),
        std::env::var("LC_ALL").unwrap_or_default(),
        std::env::var("LC_MESSAGES").unwrap_or_default(),
        std::env::var("LANG").unwrap_or_default(),
    ];

    for candidate in &candidates {
        // LANGUAGE may be colon-separated; check each token
...
fn get_translations() -> HashMap<&'static str, HashMap<&'static str, String>> {
    ...
    en.insert("software_center", "Software Center".into());
    ...
    en.insert("nav_downloads", "Downloads".into());
    ...
    en.insert("luppo_pkg", "Luppo Package".into());
    ...
    en.insert("no_description", "Luppo package description not available.".into());
    ...
    en.insert("luppo_missing", "luppo command not found".into());
    en.insert("loading_flathub", "Description loading from FlatHub...".into());
    en.insert("downloads_and_updates", "Updates ({count})".into());
    en.insert("updates_badge", "Downloads ({count})".into());
    en.insert("updates_title", "Downloads".into());
    ...
    en.insert("repo_update_success", "✅ Luppo repositories updated successfully!".into());
    ...
    en.insert("loading_app_title", "LupuS Software Center".into());
    en.insert("loading_init", "Starting…".into());
    en.insert("screenshots", "Screenshots".into());
    en.insert("technical_details", "Technical Details".into());
    en.insert("verified_package", "Verified System Package".into());
    en.insert("sandboxed_package", "Sandboxed Application".into());
    en.insert("visit_website", "Visit Website".into());
    ...
    en.insert("loading_luppo_repos", "Loading packages from Luppo repositories…".into());
    en.insert("luppo_index_loaded", "Packages loaded from Luppo repository index.".into());
    ...
    en.insert("settings_autostart_desc", "Automatically start LupuS Software Center in background when system boots".into());
    ...
    en.insert("tray_open_app", "Open".into());
    en.insert("tray_check_updates", "Check for Updates".into());
    en.insert("tray_exit", "Exit".into());
    en.insert("about_title", "About".into());
    en.insert("about_app_name", "LupuS Software Center - Luppo Market".into());
    en.insert("about_version", "Version 2.0.6".into());
    ...
    en.insert("filter_all_types", "All Types".into());
    en.insert("filter_apps_only", "Applications".into());
    en.insert("filter_pkgs_only", "Libraries & Packages".into());
    en.insert("filter_all_sources", "All Sources".into());
    en.insert("filter_source_luppo", "Luppo Repo".into());
    en.insert("filter_source_flatpak", "Flatpak".into());
    en.insert("filter_all_status", "All Statuses".into());
    en.insert("filter_status_installed", "Installed".into());
    en.insert("filter_status_not_installed", "Not Installed".into());
    en.insert("filter_status_updatable", "Has Update".into());
    en.insert("filter_all_categories", "All Categories".into());
    en.insert("sort_by", "Sort by".into());
    en.insert("sort_relevance", "Relevance".into());
    en.insert("sort_name_asc", "Name (A-Z)".into());
    en.insert("sort_name_desc", "Name (Z-A)".into());
    en.insert("sort_rating", "Rating".into());
    en.insert("sort_downloads", "Downloads".into());
    en.insert("clear_filters", "Clear Filters".into());
    en.insert("no_search_results", "No matching applications or packages found.".into());
    en.insert("no_search_results_hint", "Try searching for a different keyword or reset active filters.".into());
    en.insert("search_results_count", "{count} results found".into());
    en.insert("search_clear_btn", "Clear search".into());
    en.insert("recent_searches", "Recent Searches".into());
    en.insert("clear_history", "Clear History".into());
    en.insert("quick_filters", "Popular Searches".into());
    en.insert("settings_section_appearance", "Appearance & Theme".into());
    en.insert("settings_theme_label", "Interface Theme".into());
    en.insert("settings_theme_desc", "Choose between system default palette or dark/light modes".into());
    en.insert("theme_auto", "System Default (Auto)".into());
    en.insert("theme_dark", "Dark Theme".into());
    en.insert("theme_light", "Light Theme".into());
    en.insert("settings_section_system", "System & Maintenance".into());
    en.insert("settings_clean_cache", "Clear Application Cache".into());
    en.insert("settings_clean_cache_desc", "Removes stored Flatpak metadata and temporary icon caches".into());
    en.insert("settings_clean_cache_btn", "Clear Cache".into());
    en.insert("cache_cleared_msg", "Cache cleared successfully".into());
    en.insert("settings_general_desc", "Manage system integration and background behavior".into());
    en.insert("settings_updates_desc", "Configure automatic checks and background update policies".into());
    en.insert("settings_language_desc", "Select the display language for the application".into());
    en.insert("app_fallback", "Application".into());
    en.insert("nav_all", "Discover".into());
    en.insert("status_installing", "Installing...".into());
    en.insert("status_downloading", "Downloading...".into());
    en.insert("status_removing", "Removing...".into());
    en.insert("status_cancelled", "Cancelled".into());
    en.insert("status_completed", "Completed".into());
    en.insert("status_error", "Error".into());

    let mut tr_map = HashMap::new();
    tr_map.insert("software_center", "Yazılım Merkezi".into());
    ...
    tr_map.insert("nav_downloads", "İndirmeler".into());
    ...
    tr_map.insert("luppo_pkg", "Luppo Paketi".into());
    ...
    tr_map.insert("no_description", "Luppo paket açıklaması mevcut değil.".into());
    ...
    tr_map.insert("luppo_missing", "luppo komutu bulunamadı".into());
    tr_map.insert("loading_flathub", "Açıklama FlatHub'dan yükleniyor...".into());
    tr_map.insert("downloads_and_updates", "Güncellemeler ({count})".into());
    tr_map.insert("updates_badge", "İndirmeler ({count})".into());
    tr_map.insert("updates_title", "İndirmeler".into());
    ...
    tr_map.insert("repo_update_success", "✅ Luppo depoları başarıyla güncellendi!".into());
    tr_map.insert("zoom_in", "🔍 +".into());
    tr_map.insert("zoom_out", "🔍 -".into());
    tr_map.insert("reset", "↺ Sıfırla".into());
    tr_map.insert("close", "✕ Kapat".into());
    tr_map.insert("loading_app_title", "LupuS Yazılım Mağazası".into());
    tr_map.insert("loading_init", "Başlatılıyor…".into());
    tr_map.insert("screenshots", "Ekran Görüntüleri".into());
    tr_map.insert("technical_details", "Teknik Ayrıntılar".into());
    tr_map.insert("verified_package", "Doğrulanmış Sistem Paketi".into());
    tr_map.insert("sandboxed_package", "İzole Güvenli Uygulama".into());
    tr_map.insert("visit_website", "Web Sitesini Ziyaret Et".into());
    ...
    tr_map.insert("settings_autostart_desc", "Sistem açıldığında LupuS Yazılım Mağazası arka planda otomatik olarak çalışır".into());
    ...
    tr_map.insert("tray_open_app", "Aç".into());
    tr_map.insert("tray_check_updates", "Güncellemeleri Denetle".into());
    tr_map.insert("tray_exit", "Çıkış".into());
    tr_map.insert("about_title", "Hakkında".into());
    tr_map.insert("about_app_name", "LupuS Yazılım Mağazası - Luppo Market".into());
    tr_map.insert("about_version", "Sürüm 2.0.6".into());
    ...
    tr_map.insert("filter_all_types", "Tüm Türler".into());
    tr_map.insert("filter_apps_only", "Uygulamalar".into());
    tr_map.insert("filter_pkgs_only", "Kütüphaneler & Paketler".into());
    tr_map.insert("filter_all_sources", "Tüm Kaynaklar".into());
    tr_map.insert("filter_source_luppo", "Luppo Deposu".into());
    tr_map.insert("filter_source_flatpak", "Flatpak".into());
    tr_map.insert("filter_all_status", "Tüm Durumlar".into());
    tr_map.insert("filter_status_installed", "Kurulu".into());
    tr_map.insert("filter_status_not_installed", "Kurulu Değil".into());
    tr_map.insert("filter_status_updatable", "Güncellemesi Var".into());
    tr_map.insert("filter_all_categories", "Tüm Kategoriler".into());
    tr_map.insert("sort_by", "Sırala".into());
    tr_map.insert("sort_relevance", "En Alakalı".into());
    tr_map.insert("sort_name_asc", "İsim (A-Z)".into());
    tr_map.insert("sort_name_desc", "İsim (Z-A)".into());
    tr_map.insert("sort_rating", "Puanlama".into());
    tr_map.insert("sort_downloads", "İndirme Sayısı".into());
    tr_map.insert("clear_filters", "Filtreleri Temizle".into());
    tr_map.insert("no_search_results", "Aradığınız kriterlere uygun uygulama veya paket bulunamadı.".into());
    tr_map.insert("no_search_results_hint", "Farklı bir arama terimi deneyebilir veya aktif filtreleri sıfırlayabilirsiniz.".into());
    tr_map.insert("search_results_count", "{count} sonuç bulundu".into());
    tr_map.insert("search_clear_btn", "Aramayı temizle".into());
    tr_map.insert("recent_searches", "Son Aramalar".into());
    tr_map.insert("clear_history", "Geçmişi Temizle".into());
    tr_map.insert("quick_filters", "Popüler Aramalar".into());
    tr_map.insert("settings_section_appearance", "Görünüm ve Tema".into());
    tr_map.insert("settings_theme_label", "Arayüz Teması".into());
    tr_map.insert("settings_theme_desc", "Sistem renk paletine uyumlu otomatik tema veya açık/koyu mod seçin".into());
    tr_map.insert("theme_auto", "Sistem Varsayılanı (Otomatik)".into());
    tr_map.insert("theme_dark", "Koyu Tema".into());
    tr_map.insert("theme_light", "Açık Tema".into());
    tr_map.insert("settings_section_system", "Sistem ve Bakım".into());
    tr_map.insert("settings_clean_cache", "Uygulama Önbelleğini Temizle".into());
    tr_map.insert("settings_clean_cache_desc", "Önbelleğe alınan Flatpak verilerini ve geçici simge dosyalarını temizler".into());
    tr_map.insert("settings_clean_cache_btn", "Önbelleği Temizle".into());
    tr_map.insert("cache_cleared_msg", "Önbellek başarıyla temizlendi".into());
    tr_map.insert("settings_general_desc", "Sistem entegrasyonu ve arka plan çalışma davranışını yönetin".into());
    tr_map.insert("settings_updates_desc", "Otomatik denetleme sıklığını ve güncelleme ilkelerini yapılandırın".into());
    tr_map.insert("settings_language_desc", "Uygulamanın görüntüleneceği dili seçin".into());
    tr_map.insert("app_fallback", "Uygulama".into());
    tr_map.insert("nav_all", "Keşfet".into());
    tr_map.insert("status_installing", "Kuruluyor...".into());
    tr_map.insert("status_downloading", "İndiriliyor...".into());
    tr_map.insert("status_removing", "Kaldırılıyor...".into());
    tr_map.insert("status_cancelled", "İptal Edildi".into());
    tr_map.insert("status_completed", "Tamamlandı".into());
    tr_map.insert("status_error", "Hata".into());
